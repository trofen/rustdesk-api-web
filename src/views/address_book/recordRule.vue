...
<script setup>
  ...
  import { useRepositories } from '@/views/address_book/recordRule'
  ...
  formData.collection_id = props.record.collection_id
  formData.address_book_row_id = props.record.row_id
  formData.user_id = props.record.user_id
  listQuery.collection_id = props.record.collection_id
  listQuery.address_book_row_id = props.record.row_id
